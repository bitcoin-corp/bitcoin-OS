...
import { Wallet, Mail, Music, FileText, HardDrive, Globe, Terminal, Settings, Calendar, Search, LineChart, Briefcase, Table, Share2 } from 'lucide-react'
...
const desktopApps = [
  ...
  { name: 'Bitcoin Jobs', icon: Briefcase, color: 'text-amber-500', url: 'https://bitcoin-jobs.vercel.app', external: true },
