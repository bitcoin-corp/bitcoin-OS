      ...
      <div className={`grants-page ${mounted && !isMobile && !devSidebarCollapsed ? 'with-sidebar-expanded' : ''} ${mounted && !isMobile && devSidebarCollapsed ? 'with-sidebar-collapsed' : ''}`}>
        <div className="grants-container">
          ...
          <section className="grants-hero">
            ...
            <h1>Bitcoin Marketing <span style={{color: '#FF6B35'}}>Grants</span></h1>
          ...
          <section className="mission-section">
            ...
            <div className="mission-content">
              <p className="mission-statement">
                Bitcoin Marketing creates <strong>a unique funding ecosystem</strong> where quality work gets recognized through 
              ...
              <div className="mission-pillars">
                <div className="pillar">
                  ...
                  <h3>Bitcoin Marketing Curation</h3>
          ...
          <section className="focus-section">
            ...
            <div className="focus-content">
              <p className="focus-intro">
                Our platform showcases exceptional work across key innovation areas. Bitcoin Marketing awards $BWRITER tokens 
              ...
              <div className="focus-areas">
                <div className="focus-area">
                  ...
                  <h4>Bitcoin Marketing Platform Development</h4>
                  <ul>
                  ...
                  <div style={{marginTop: '10px', fontSize: '12px', color: '#FF6B35'}}>
                    Bitcoin Marketing awards $BWRITER for platform improvements
                  </div>
                </div>
          ...
          <section className="cta-section">
            <div className="cta-content">
              ...
              <p>
                Apply for Bitcoin Marketing grants to support your innovative projects in blockchain publishing and development. 
          ...
          <section className="footer-note">
            <p>
              <strong>Note:</strong> Bitcoin Marketing awards grants in $BWRITER tokens to support innovative projects. 
