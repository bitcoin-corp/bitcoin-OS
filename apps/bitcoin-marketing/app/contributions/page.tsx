...
export default function ContributionsPage() {
  ...
  const fetchContributors = async () => {
    try {
      const response = await fetch('https://api.github.com/repos/bitcoin-apps-suite/bitcoin-marketing/contributors');
      if (response.ok) {
        ...
        <div className="bwriter-contributions-page">
          <div className="contributions-container">
            <section className="contributions-hero">
              <h1>$BMarketing <span style={{color: '#ffffff'}}>Development Hub</span></h1>
              <p className="contributions-tagline">
                Contribute to Bitcoin Marketing and earn $BMarketing tokens
              </p>
    ...
    <div className="App">
        ...
        <div className="contributions-content">
          <div className="github-section">
            ...
            <div className="repo-link">
              <a 
                href="https://github.com/bitcoin-apps-suite/bitcoin-marketing" 
                target="_blank" 
              ...
              >
                ...
                bitcoin-apps-suite/bitcoin-marketing
              </a>
            </div>
      ...
      {activeTab === 'todo' && (
        <div className="todo-content">
          <div className="todo-header">
            ...
            <p>Pick a task, submit a PR, and earn $BMarketing tokens!</p>
          </div>
                ...
                <div className="todo-footer">
                  <div className="token-reward">
                    ...
                    <span className="reward-amount">
                      ({(TOTAL_TOKENS * item.tokenReward / 100).toLocaleString()} $BMarketing)
                    </span>
                  </div>
                  {item.status === 'open' && (
                    <button 
                  ...
                  {item.githubIssueNumber && (
                    <a 
                      href={`https://github.com/bitcoin-apps-suite/bitcoin-marketing/issues/${item.githubIssueNumber}`}
                      target="_blank"
                      rel="noopener noreferrer"
          ...
          <div className="contribution-guidelines">
            ...
            <ol>
              ...
              <li>Once merged, receive your $BMarketing tokens!</li>
            </ol>
      ...
      {activeTab === 'tokenomics' && (
        <div className="tokenomics-content">
          <h2>$BMarketing Token Distribution</h2>
          
          <div className="token-overview">
            <div className="total-supply">
              <h3>Total Supply</h3>
              <div className="supply-value">{TOTAL_TOKENS.toLocaleString()} $BMarketing</div>
            </div>
          </div>
          ...
          <div className="token-utility">
            <h3>$BMarketing Token Utility</h3>
            <ul>
