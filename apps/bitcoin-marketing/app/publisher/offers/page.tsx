...
const PublisherOffersPage: React.FC = () => {
  ...
  return (
    <div className="app-wrapper">
      <div className={`offers-page ${mounted && !isMobile && !devSidebarCollapsed ? 'with-sidebar-expanded' : ''} ${mounted && !isMobile && devSidebarCollapsed ? 'with-sidebar-collapsed' : ''}`}>
        
        {/* Hero Section */}
        <section className="offers-hero">
          <h1>Browse Publisher <span style={{color: '#F7931E'}}>Commissions</span></h1>
...
export default PublisherOffersPage;