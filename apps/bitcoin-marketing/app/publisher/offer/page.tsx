...
const PublisherOfferPage: React.FC = () => {
  ...
  return (
    <div className="app-wrapper">
      <div className={`publisher-offer-page ${mounted && !isMobile && !devSidebarCollapsed ? 'with-sidebar-expanded' : ''} ${mounted && !isMobile && devSidebarCollapsed ? 'with-sidebar-collapsed' : ''}`}>
