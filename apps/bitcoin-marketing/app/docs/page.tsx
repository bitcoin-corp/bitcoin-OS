    ...
    <div className="app-wrapper">
      ...
      <div className="docs-container">
        ...
        <section className="docs-hero">
          <h1><span style={{color: '#f7931a'}}>Bitcoin Marketing</span> Documentation</h1>
        ...
        <section className="getting-started-section">
          ...
          <div className="getting-started-content">
            <p>
              Bitcoin Marketing is a <strong>decentralized document platform</strong> that stores your work 
        ...
        <section className="writing-section">
          ...
          <div className="writing-content">
            <p className="intro">
              The Bitcoin Marketing editor provides a powerful yet intuitive writing experience with 
        ...
        <section className="api-section">
          ...
          <div className="api-content">
            <p>
              <strong>REST API:</strong> Bitcoin Marketing provides a comprehensive REST API for document 
          ...
          <div className="troubleshooting-content">
            <div className="faq-grid">
              ...
              <div className="faq-item">
                ...
                <p>Double-check password, Bitcoin Marketing cannot recover lost passwords for security</p>
              </div>
              <div className="faq-item">
            ...
            <div className="support-links">
              ...
              <div className="support-grid">
                <div className="support-item">
                  ...
                  <a href="https://github.com/bitcoin-apps-suite/bitcoin-marketing/issues" target="_blank" rel="noopener noreferrer">
                    Submit Issue
                  </a>
                </div>
                <div className="support-item">
