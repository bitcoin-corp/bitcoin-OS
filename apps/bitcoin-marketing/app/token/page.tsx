    ...
    <div className="App">
      ...
      <div className="token-container">
        ...
        <section className="token-hero">
          <h1><span style={{color: '#ffffff'}}>The</span> <span style={{color: '#f7931a'}}>Bitcoin Marketing</span> <span style={{color: '#ffffff'}}>Token</span></h1>
        ...
        <section className="philosophy-section">
          ...
          <div className="philosophy-content">
            <p>
              Bitcoin Marketing is an <strong>open-source project</strong> licensed under MIT and BSV licenses. 
          ...
          <div className="business-content">
            ...
            <div className="value-flow">
              ...
              <p style={{textAlign: 'center', marginTop: '20px', fontSize: '14px', color: 'rgba(255, 255, 255, 0.6)'}}>
                The Bitcoin Marketing Exchange enables creators to tokenize, sell shares, and trade their work,
        ...
        <section className="legal-section">
          ...
          <div className="legal-content">
            ...
            <p>
              ...
              on the Bitcoin Marketing Exchange and associated platforms. We encourage an active secondary 
