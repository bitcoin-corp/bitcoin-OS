...
export class BitcoinMarketingNFTService implements NFTService {
  private readonly MAGIC_NUMBER = 'BWNF'; // Bitcoin Marketing NFT
  ...
  private createPlatformSignature(nft: NFTFile): string {
    ...
    const dataToSign = nft.header.contentHash + nft.metadata.title + 'BitcoinMarketing';
