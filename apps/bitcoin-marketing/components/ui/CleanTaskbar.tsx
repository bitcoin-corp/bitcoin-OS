  ...
  const menus: MenuData[] = [
    {
      ...
      items: [
        ...
        { divider: true },
        { label: 'Bitcoin Marketing Pro...', action: () => window.dispatchEvent(new CustomEvent('openSubscriptionModal')) },
        { label: 'Add BSV Balance...', action: () => window.dispatchEvent(new CustomEvent('openTopUpModal')) },
        { divider: true },
        { label: 'Hide Bitcoin Marketing', shortcut: '⌘H', action: () => console.log('Hide') },
    ...
    },
    {
      label: 'Developers',
      items: [
        { label: 'BAP Executive Summary', href: '/bitcoin-marketing/bap' },
        { divider: true },
        { label: 'BSV SDK Docs', href: 'https://docs.bsvblockchain.org' },
        { label: 'HandCash SDK Docs', href: 'https://docs.handcash.io' },
        { divider: true },
        { label: 'GitHub Repository', href: 'https://github.com/bitcoin-apps-suite/bitcoin-marketing' },
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Bitcoin Marketing Help', shortcut: '⌘?', action: () => alert('Bitcoin Marketing v2.0\n\nWrite, encrypt, and store documents on the Bitcoin blockchain') },
        ...
        { divider: true },
        { label: 'Report an Issue', href: 'https://github.com/bitcoin-apps-suite/bitcoin-marketing/issues' },
