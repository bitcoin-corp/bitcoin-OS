...
const DevSidebar: React.FC<DevSidebarProps> = ({ onCollapsedChange }) => {
  ...
  useEffect(() => {
    ...
    fetch('https://api.github.com/repos/bitcoin-apps-suite/bitcoin-marketing/issues?state=open')
      .then(res => res.json())
  ...
  const menuItems: Array<{
    ...
    { path: 'https://github.com/bitcoin-apps-suite/bitcoin-marketing', icon: GitBranch, label: 'GitHub', external: true },
