  ...
  return (
    <div className="pro-taskbar" ref={menuRef}>
      ...
      <div className="taskbar-menus">
        {/* Bitcoin Marketing Menu */}
        <div 
          className={`menu-item ${activeMenu === 'app' ? 'active' : ''}`}
          onClick={() => handleMenuClick('app')}
          onMouseEnter={() => handleMenuHover('app')}
        >
          <span className="menu-title">Bitcoin Marketing</span>
          {activeMenu === 'app' && (
            <div className="menu-dropdown">
              <div className="dropdown-item">About Bitcoin Marketing</div>
              ...
              <div className="dropdown-divider" />
              <div className="dropdown-item">
                <span>Hide Bitcoin Marketing</span>
              ...
              <div className="dropdown-item" onClick={onLogout}>
                <span>Quit Bitcoin Marketing</span>
        ...
        >
          ...
          {activeMenu === 'help' && (
            <div className="menu-dropdown">
              <div className="dropdown-item">Bitcoin Marketing Help</div>
            </div>
          )}
        </div>
      </div>
