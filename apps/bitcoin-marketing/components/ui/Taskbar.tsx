...
const Taskbar: React.FC<TaskbarProps> = ({
  ...
  return (
    <div 
      ref={menuRef}
      className="bitcoin-marketing-taskbar"
    >
      {/* Bitcoin Logo */}
      <div 
      ...
      <button 
        ...
        title="Bitcoin Marketing - Tap to go home"
      >
        <span className="bitcoin-symbol">₿</span>
        <span>Bitcoin Marketing</span>
      </button>
