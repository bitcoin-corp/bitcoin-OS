      ...
      <div className="unified-auth-container">
        ...
        <AuthModal isOpen={showAuthModal} onClose={() => setShowAuthModal(false)}>
              <div className="auth-modal-header">
                <h2>Connect to Bitcoin Marketing</h2>
              ...
              <div className="auth-modal-content">
                ...
                <div className="auth-benefits">
                  ...
                  <p className="simple-explanation">
                    Bitcoin Marketing allows you to write documents directly on the blockchain, encrypt, timelock, publish, charge for access, post to Twitter and Substack, and backup to Google Drive or send via Gmail. Connect your HandCash wallet to receive payments, tokenize your documents and issue dividend bearing shares in the revenue they generate that can be independently traded on decentralized exchanges. Subscribe to top-up with monthly bitcoin straight to your HandCash wallet or directly to your Bitcoin Marketing wallet.
                  </p>
