  ...
  useEffect(() => {
    if ('serviceWorker' in navigator) {
      navigator.serviceWorker
        ...
        .then((registration) => {
          console.log('Bitcoin Drive SW registered: ', registration);
            ...
            if (newWorker) {
              newWorker.addEventListener('statechange', () => {
                if (newWorker.state === 'installed' && navigator.serviceWorker.controller) {
                  console.log('Bitcoin Drive SW updated');
        ...
        .catch((registrationError) => {
          console.log('Bitcoin Drive SW registration failed: ', registrationError);
        });
