    ...
    <div className="token-page">
      <div className="token-container">
        ...
        <section className="token-hero">
          <h1><span style={{color: '#ffffff'}}>The</span> <span style={{color: '#ef4444'}}>Bitcoin</span> Email <span style={{color: '#ffffff'}}>Token</span></h1>
        ...
        <section className="philosophy-section">
          ...
          <div className="philosophy-content">
            <p>
              Bitcoin Email is an <strong>open-source project</strong> licensed under MIT and BSV licenses. 
          ...
          <div className="business-content">
            ...
            <div className="business-model">
              ...
              <div className="revenue-streams">
                <div className="stream">
                  <h4>List Sales</h4>
                  <p>Users tokenize & sell mailing lists</p>
                  <p className="price">2.5% fee</p>
                </div>
                <div className="stream featured">
                  <h4>Share Trading</h4>
                  <p>Secondary market for list shares</p>
                  <p className="price">1.5% fee</p>
                </div>
                <div className="stream">
                  <h4>NFT Marketplace</h4>
                  <p>Premium lists & collections</p>
            ...
            <div className="value-flow">
              ...
              <p style={{textAlign: 'center', marginTop: '20px', fontSize: '14px', color: 'rgba(255, 255, 255, 0.6)'}}>
                The Bitcoin Email Exchange enables users to tokenize, sell shares, and trade their mailing lists,
